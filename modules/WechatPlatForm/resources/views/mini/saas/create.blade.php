...
<div class="ibox float-e-margins">
    ...
    <div class="ibox-content">
        ...
        <form action="{{route('admin.mini.saas.store')}}" method="post" id="store">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" class="form-control taginput" name="name" placeholder="" value="" />
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" class="form-control taginput" name="type" placeholder="" value="" />
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" class="form-control taginput" name="code" placeholder="" value="" />
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <textarea rows="8" class="col-sm-12" name="description" ></textarea>
